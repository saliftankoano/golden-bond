...
interface PrivatePartyFindProps {
  title?: string
  steps?: Step[]
}
...
export const PrivatePartyFind: React.FC<PrivatePartyFindProps> = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="flex flex-col items-center justify-center w-[500px] h-[58px] mb-[80px]"
        variants={headerVariants}
      >
        <h2 className="garamond-font text-[48px] text-black leading-[120%]">{title}</h2>
      </motion.div>

      {/* Steps Grid */}
      <motion.div
        className="flex gap-[20px] max-w-[1350px] mx-auto px-[20px]"
        variants={containerVariants}
      >
