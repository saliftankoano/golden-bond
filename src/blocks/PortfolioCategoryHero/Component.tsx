...
interface PortfolioCategoryHeroBlockProps {
  title?: string
  subtitle?: string
  buttonText?: string
...
export const PortfolioCategoryHeroBlock: React.FC<PortfolioCategoryHeroBlockProps> = ({
  title = 'Name Event',
  subtitle = 'Explore our wide variety of past work',
