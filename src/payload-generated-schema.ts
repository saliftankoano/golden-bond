...
export const pages_blocks_services_services_buttons = sqliteTable(
  'pages_blocks_services_services_buttons',
  {
    _order: integer('_order').notNull(),
    _parentID: text('_parent_id').notNull(),
    id: text('id').primaryKey(),
    label: text('label'),
    style: text('style', { enum: ['primary', 'secondary'] }),
    link: text('link'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_services_services_buttons_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_services_services_buttons_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_services_services.id],
      name: 'pages_blocks_services_services_buttons_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_services_services = sqliteTable(
...
export const pages_blocks_services = sqliteTable(
...
export const pages_blocks_experience_images = sqliteTable(
  'pages_blocks_experience_images',
  {
    _order: integer('_order').notNull(),
    _parentID: text('_parent_id').notNull(),
    id: text('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_experience_images_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_experience_images_parent_id_idx').on(columns._parentID),
    pages_blocks_experience_images_image_idx: index('pages_blocks_experience_images_image_idx').on(
      columns.image,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_experience.id],
      name: 'pages_blocks_experience_images_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_experience = sqliteTable(
  'pages_blocks_experience',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_experience_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_experience_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_experience_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_experience_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_about_hero = sqliteTable(
  'pages_blocks_about_hero',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: text('id').primaryKey(),
    title: text('title').default('Tailored Events for Every Occasion'),
    ...
    buttonText: text('button_text').default('Plan My Event'),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_about_hero_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_about_hero_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_about_hero_path_idx').on(columns._path),
    pages_blocks_about_hero_image_idx: index('pages_blocks_about_hero_image_idx').on(columns.image),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_about_hero_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_founder = sqliteTable(
  'pages_blocks_founder',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: text('id').primaryKey(),
    sectionLabel: text('section_label').default('Golden Bond Team'),
    sectionTitle: text('section_title').default('Meet Our Team'),
    sectionDescription: text('section_description').default(
      'Golden Bond Jewelry creates custom-fit, welded permanent jewelry in 14K gold and sterling silver, as well as clasped and ready to wear jewelry.',
    ),
    founderLabel: text('founder_label').default('MEET The Ceo and her four-legged colleague'),
    founderName: text('founder_name').default('Lexie & Cash'),
    founderStory: text('founder_story', { mode: 'json' }),
    founderImage: integer('founder_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    blockName: text('block_name'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_founder_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_founder_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_founder_path_idx').on(columns._path),
    pages_blocks_founder_founder_image_idx: index('pages_blocks_founder_founder_image_idx').on(
      columns.founderImage,
    ),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_founder_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_experts_experts = sqliteTable(
  'pages_blocks_experts_experts',
  {
    _order: integer('_order').notNull(),
    _parentID: text('_parent_id').notNull(),
    id: text('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_experts_experts_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_experts_experts_parent_id_idx').on(columns._parentID),
    pages_blocks_experts_experts_image_idx: index('pages_blocks_experts_experts_image_idx').on(
      columns.image,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_experts.id],
      name: 'pages_blocks_experts_experts_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_experts = sqliteTable(
  'pages_blocks_experts',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: text('id').primaryKey(),
    sectionLabel: text('section_label').default('Golden Bond Team'),
    sectionTitle: text('section_title').default('Our Experts.'),
    sectionDescription: text('section_description').default(
      'Golden Bond Jewelry creates custom-fit, welded permanent jewelry in 14K gold and sterling silver, as well as clasped and ready to wear jewelry.',
    ),
    blockName: text('block_name'),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_experts_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_experts_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_experts_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_experts_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_about_c_t_a = sqliteTable(
  'pages_blocks_about_c_t_a',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: text('id').primaryKey(),
    title: text('title').default('The Golden Bond | Event & Design'),
    heading: text('heading').default('Reserve Your Exquisite Jewelry Experience!'),
    description: text('description').default(
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_about_c_t_a_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_about_c_t_a_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_about_c_t_a_path_idx').on(columns._path),
    pages_blocks_about_c_t_a_image_idx: index('pages_blocks_about_c_t_a_image_idx').on(
      columns.image,
    ),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_about_c_t_a_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const pages = sqliteTable(
  'pages',
  {
    ...
    title: text('title'),
    hero_type: text('hero_type', { enum: ['none', 'landingHero'] }).default('none'),
...
export const _pages_v_blocks_services_services_buttons = sqliteTable(
  '_pages_v_blocks_services_services_buttons',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: integer('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_services_services_buttons_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_services_services_buttons_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_services_services.id],
      name: '_pages_v_blocks_services_services_buttons_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_services_services = sqliteTable(
...
export const _pages_v_blocks_services = sqliteTable(
...
export const _pages_v_blocks_experience_images = sqliteTable(
  '_pages_v_blocks_experience_images',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: integer('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_experience_images_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_experience_images_parent_id_idx').on(columns._parentID),
    _pages_v_blocks_experience_images_image_idx: index(
      '_pages_v_blocks_experience_images_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_experience.id],
      name: '_pages_v_blocks_experience_images_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_experience = sqliteTable(
  '_pages_v_blocks_experience',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_experience_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_experience_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_experience_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_experience_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_about_hero = sqliteTable(
  '_pages_v_blocks_about_hero',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_about_hero_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_about_hero_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_about_hero_path_idx').on(columns._path),
    _pages_v_blocks_about_hero_image_idx: index('_pages_v_blocks_about_hero_image_idx').on(
      columns.image,
    ),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_about_hero_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_founder = sqliteTable(
  '_pages_v_blocks_founder',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_founder_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_founder_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_founder_path_idx').on(columns._path),
    _pages_v_blocks_founder_founder_image_idx: index(
      '_pages_v_blocks_founder_founder_image_idx',
    ).on(columns.founderImage),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_founder_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_experts_experts = sqliteTable(
  '_pages_v_blocks_experts_experts',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: integer('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_experts_experts_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_experts_experts_parent_id_idx').on(columns._parentID),
    _pages_v_blocks_experts_experts_image_idx: index(
      '_pages_v_blocks_experts_experts_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_experts.id],
      name: '_pages_v_blocks_experts_experts_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_experts = sqliteTable(
  '_pages_v_blocks_experts',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_experts_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_experts_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_experts_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_experts_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_about_c_t_a = sqliteTable(
  '_pages_v_blocks_about_c_t_a',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_about_c_t_a_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_about_c_t_a_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_about_c_t_a_path_idx').on(columns._path),
    _pages_v_blocks_about_c_t_a_image_idx: index('_pages_v_blocks_about_c_t_a_image_idx').on(
      columns.image,
    ),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_about_c_t_a_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _pages_v = sqliteTable(
  '_pages_v',
  {
    ...
    version_hero_type: text('version_hero_type', { enum: ['none', 'landingHero'] }).default('none'),
...
export const relations_pages_blocks_services_services_buttons = relations(
  pages_blocks_services_services_buttons,
  ({ one }) => ({
    _parentID: one(pages_blocks_services_services, {
      fields: [pages_blocks_services_services_buttons._parentID],
...
export const relations_pages_blocks_services_services = relations(
  ...
  ({ one, many }) => ({
    ...
    buttons: many(pages_blocks_services_services_buttons, {
      relationName: 'buttons',
    }),
  }),
)
...
export const relations_pages_blocks_experience_images = relations(
  pages_blocks_experience_images,
  ({ one }) => ({
    _parentID: one(pages_blocks_experience, {
      fields: [pages_blocks_experience_images._parentID],
      references: [pages_blocks_experience.id],
      relationName: 'images',
    }),
    image: one(media, {
      fields: [pages_blocks_experience_images.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations_pages_blocks_experience = relations(
  pages_blocks_experience,
  ({ one, many }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_experience._parentID],
      references: [pages.id],
      relationName: '_blocks_experience',
    }),
    images: many(pages_blocks_experience_images, {
      relationName: 'images',
    }),
  }),
)
export const relations_pages_blocks_about_hero = relations(pages_blocks_about_hero, ({ one }) => ({
  _parentID: one(pages, {
    fields: [pages_blocks_about_hero._parentID],
    references: [pages.id],
    relationName: '_blocks_aboutHero',
  }),
  image: one(media, {
    fields: [pages_blocks_about_hero.image],
    references: [media.id],
    relationName: 'image',
  }),
}))
export const relations_pages_blocks_founder = relations(pages_blocks_founder, ({ one }) => ({
  _parentID: one(pages, {
    fields: [pages_blocks_founder._parentID],
    references: [pages.id],
    relationName: '_blocks_founder',
  }),
  founderImage: one(media, {
    fields: [pages_blocks_founder.founderImage],
    references: [media.id],
    relationName: 'founderImage',
  }),
}))
export const relations_pages_blocks_experts_experts = relations(
  pages_blocks_experts_experts,
  ({ one }) => ({
    _parentID: one(pages_blocks_experts, {
      fields: [pages_blocks_experts_experts._parentID],
      references: [pages_blocks_experts.id],
      relationName: 'experts',
    }),
    image: one(media, {
      fields: [pages_blocks_experts_experts.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations_pages_blocks_experts = relations(pages_blocks_experts, ({ one, many }) => ({
  _parentID: one(pages, {
    fields: [pages_blocks_experts._parentID],
    references: [pages.id],
    relationName: '_blocks_experts',
  }),
  experts: many(pages_blocks_experts_experts, {
    relationName: 'experts',
  }),
}))
export const relations_pages_blocks_about_c_t_a = relations(
  pages_blocks_about_c_t_a,
  ({ one }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_about_c_t_a._parentID],
      references: [pages.id],
      relationName: '_blocks_aboutCTA',
    }),
    image: one(media, {
      fields: [pages_blocks_about_c_t_a.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  _blocks_experience: many(pages_blocks_experience, {
    relationName: '_blocks_experience',
  }),
  _blocks_aboutHero: many(pages_blocks_about_hero, {
    relationName: '_blocks_aboutHero',
  }),
  _blocks_founder: many(pages_blocks_founder, {
    relationName: '_blocks_founder',
  }),
  _blocks_experts: many(pages_blocks_experts, {
    relationName: '_blocks_experts',
  }),
  _blocks_aboutCTA: many(pages_blocks_about_c_t_a, {
    relationName: '_blocks_aboutCTA',
  }),
...
export const relations__pages_v_blocks_services_services_buttons = relations(
  _pages_v_blocks_services_services_buttons,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_services_services, {
      fields: [_pages_v_blocks_services_services_buttons._parentID],
...
export const relations__pages_v_blocks_services_services = relations(
  ...
  ({ one, many }) => ({
    ...
    buttons: many(_pages_v_blocks_services_services_buttons, {
      relationName: 'buttons',
    }),
  }),
)
...
export const relations__pages_v_blocks_experience_images = relations(
  _pages_v_blocks_experience_images,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_experience, {
      fields: [_pages_v_blocks_experience_images._parentID],
      references: [_pages_v_blocks_experience.id],
      relationName: 'images',
    }),
    image: one(media, {
      fields: [_pages_v_blocks_experience_images.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations__pages_v_blocks_experience = relations(
  _pages_v_blocks_experience,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_experience._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_experience',
    }),
    images: many(_pages_v_blocks_experience_images, {
      relationName: 'images',
    }),
  }),
)
export const relations__pages_v_blocks_about_hero = relations(
  _pages_v_blocks_about_hero,
  ({ one }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_about_hero._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_aboutHero',
    }),
    image: one(media, {
      fields: [_pages_v_blocks_about_hero.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations__pages_v_blocks_founder = relations(_pages_v_blocks_founder, ({ one }) => ({
  _parentID: one(_pages_v, {
    fields: [_pages_v_blocks_founder._parentID],
    references: [_pages_v.id],
    relationName: '_blocks_founder',
  }),
  founderImage: one(media, {
    fields: [_pages_v_blocks_founder.founderImage],
    references: [media.id],
    relationName: 'founderImage',
  }),
}))
export const relations__pages_v_blocks_experts_experts = relations(
  _pages_v_blocks_experts_experts,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_experts, {
      fields: [_pages_v_blocks_experts_experts._parentID],
      references: [_pages_v_blocks_experts.id],
      relationName: 'experts',
    }),
    image: one(media, {
      fields: [_pages_v_blocks_experts_experts.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations__pages_v_blocks_experts = relations(
  _pages_v_blocks_experts,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_experts._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_experts',
    }),
    experts: many(_pages_v_blocks_experts_experts, {
      relationName: 'experts',
    }),
  }),
)
export const relations__pages_v_blocks_about_c_t_a = relations(
  _pages_v_blocks_about_c_t_a,
  ({ one }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_about_c_t_a._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_aboutCTA',
    }),
    image: one(media, {
      fields: [_pages_v_blocks_about_c_t_a.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  _blocks_experience: many(_pages_v_blocks_experience, {
    relationName: '_blocks_experience',
  }),
  _blocks_aboutHero: many(_pages_v_blocks_about_hero, {
    relationName: '_blocks_aboutHero',
  }),
  _blocks_founder: many(_pages_v_blocks_founder, {
    relationName: '_blocks_founder',
  }),
  _blocks_experts: many(_pages_v_blocks_experts, {
    relationName: '_blocks_experts',
  }),
  _blocks_aboutCTA: many(_pages_v_blocks_about_c_t_a, {
    relationName: '_blocks_aboutCTA',
  }),
...
type DatabaseSchema = {
  ...
  pages_blocks_services_services_buttons: typeof pages_blocks_services_services_buttons
  pages_blocks_services_services: typeof pages_blocks_services_services
  pages_blocks_services: typeof pages_blocks_services
  pages_blocks_experience_images: typeof pages_blocks_experience_images
  pages_blocks_experience: typeof pages_blocks_experience
  pages_blocks_about_hero: typeof pages_blocks_about_hero
  pages_blocks_founder: typeof pages_blocks_founder
  pages_blocks_experts_experts: typeof pages_blocks_experts_experts
  pages_blocks_experts: typeof pages_blocks_experts
  pages_blocks_about_c_t_a: typeof pages_blocks_about_c_t_a
  pages: typeof pages
  ...
  _pages_v_blocks_services_services_buttons: typeof _pages_v_blocks_services_services_buttons
  ...
  _pages_v_blocks_experience_images: typeof _pages_v_blocks_experience_images
  _pages_v_blocks_experience: typeof _pages_v_blocks_experience
  _pages_v_blocks_about_hero: typeof _pages_v_blocks_about_hero
  _pages_v_blocks_founder: typeof _pages_v_blocks_founder
  _pages_v_blocks_experts_experts: typeof _pages_v_blocks_experts_experts
  _pages_v_blocks_experts: typeof _pages_v_blocks_experts
  _pages_v_blocks_about_c_t_a: typeof _pages_v_blocks_about_c_t_a
  ...
  relations_pages_blocks_services_services_buttons: typeof relations_pages_blocks_services_services_buttons
  ...
  relations_pages_blocks_experience_images: typeof relations_pages_blocks_experience_images
  relations_pages_blocks_experience: typeof relations_pages_blocks_experience
  relations_pages_blocks_about_hero: typeof relations_pages_blocks_about_hero
  relations_pages_blocks_founder: typeof relations_pages_blocks_founder
  relations_pages_blocks_experts_experts: typeof relations_pages_blocks_experts_experts
  relations_pages_blocks_experts: typeof relations_pages_blocks_experts
  relations_pages_blocks_about_c_t_a: typeof relations_pages_blocks_about_c_t_a
  ...
  relations__pages_v_blocks_services_services_buttons: typeof relations__pages_v_blocks_services_services_buttons
  ...
  relations__pages_v_blocks_experience_images: typeof relations__pages_v_blocks_experience_images
  relations__pages_v_blocks_experience: typeof relations__pages_v_blocks_experience
  relations__pages_v_blocks_about_hero: typeof relations__pages_v_blocks_about_hero
  relations__pages_v_blocks_founder: typeof relations__pages_v_blocks_founder
  relations__pages_v_blocks_experts_experts: typeof relations__pages_v_blocks_experts_experts
  relations__pages_v_blocks_experts: typeof relations__pages_v_blocks_experts
  relations__pages_v_blocks_about_c_t_a: typeof relations__pages_v_blocks_about_c_t_a
