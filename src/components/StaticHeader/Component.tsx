      ...
      <header className="relative h-[105px] max-h-[105px] bg-[#F4F1EB] px-4 md:px-6 py-2 lg:py-3">
        <nav className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div className="flex items-center hover:cursor-pointer lg:hidden">
            <Link href="/">
              <Image src="/images/logo.svg" alt="Golden Bond" width={72} height={71} />
            </Link>
          </div>
          ...
          {isEventsOpen && (
            <div className="fixed inset-0 z-40" onClick={() => setIsEventsOpen(false)} />
          )}
        </nav>
      </header>
          ...
          <div className="flex-1 flex flex-col items-center justify-center space-y-8 tenor-font">
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              >
                <span>EVENTS</span>
                <ChevronDown
                  className={`w-5 h-5 transition-transform ${isEventsOpen ? 'rotate-180' : ''}`}
                />
              </button>
